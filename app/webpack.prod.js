...
// MODIFICATION DE CES 2 LIGNES (Avant, elles pointaient sur http://localhost:5001/api/rest, ce qui contourne Nginx et bloque en prod)
const API_BASE_URL = process.env.API_EP_URI ?? '/api/v1';
const RT_API_BASE_URL = process.env.RT_API_EP_URI ?? '/wsapi';
...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      APP_ENV_RT_API_BASE_URL: JSON.stringify(RT_API_BASE_URL),
    }),
